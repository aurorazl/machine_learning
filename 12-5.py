    ...
    def fit(self,X,y,print_progress=False):
        ...
        for i in range(self.epochs):
            ...
            for idx in mini:
                ...
                grad_diff = self._gradient_checking(X[idx],y_enc[:,idx],self.w1,self.w2,1e-5,grad1,grad2)
                if grad_diff<=1e-7:
...
nn_check = MLPGradientCheck(n_output=10,n_features=X_train.shape[1],n_hidden=10,l2=0.0,l1=0.0,epochs=10,eta=0.001,alpha=0.0,
                  decrease_const=0.0,shuffle=False,minibatches=1,random_state=1)
